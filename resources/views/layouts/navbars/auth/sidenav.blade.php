        ...
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'home' ? 'active' : '' }}" href="{{ route('home') }}">
                    ...
                    <span class="nav-link-text ms-1">Dashboard aniq powers</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link {{ str_contains(request()->url(), 'ai-integration') == true ? 'active' : '' }}" href="http://219.92.88.84:81">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
